...
from .custom_mixin import CustomGenerationMixin
...
def eager_attention_forward(
    ...
    **kwargs: Unpack[TransformersKwargs],
    ...
    if attention_logits_intervention_vector is not None:
        # Handle multi-GPU case: move intervention vector to the same device as attn_weights
...
class RescaleLlamaDecoderLayer(GradientCheckpointingLayer):
    def __init__(self, config: LlamaConfig, layer_idx: int):
        super().__init__()
        self.hidden_size = config.hidden_size

        self.self_attn = RescaleLlamaAttention(config=config, layer_idx=layer_idx)
...
class LlamaPreTrainedModel(PreTrainedModel):
    ...
    _no_split_modules = ["RescaleLlamaDecoderLayer"]
    ...
    _can_record_outputs = {
        "hidden_states": RescaleLlamaDecoderLayer,
        "attentions": RescaleLlamaAttention,
    }
